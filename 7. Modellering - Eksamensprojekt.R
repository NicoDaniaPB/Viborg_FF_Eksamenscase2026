...
qr(kampdag_X)$rank
ncol(kampdag_X)
# Vi har 59 kolonner, 47 kolonner er ikke lineært afhængige af andre kolonner. 
...
# Vi kør K-fold CV for Lasso regressions modellen, da det er den model med den 
# laveste RMSE
...
# Vi ser resultatet
tilskuere_pred
# Vores estimat for kampdagen er 6057 tilskuere. Vi skal huske, at der kan være
...
# et sted mellem 4663 til 7452 tilskuere. 
