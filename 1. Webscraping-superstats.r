...
# Læser HTML-siden direkte fra URL'en med read_html og gemmer den i containeren html_superstats.
...
#> Det er tabel 3 der er den rigtige tabel, som indeholder de sæsoner VFF er i Superligaen.
...
#> Opretter en samlet datetime-variabel (dttm) gør det nemmere når datasættet skal merges med andre datasæt senere.
...
#> Laver to nye kolonner med point til hjemme- og udeholdet.
...
#> men på superstats hjemmeside er der mellem rum efter "-" ved hold med kun to bogstaver.
...
#> Fryser bundholdenes placering efter runde 32 i sæsonen 2016/2017.
#> I denne sæson spiller kun top-6 videre efter runde 32 om placeringer. 
#> Joiner først deres placering fra runde 32 (frys_plac),
...
#> Output: 318. Det er klasse, da VFF ifølge Superstats har spillet 327 hjemmekampe all time.
